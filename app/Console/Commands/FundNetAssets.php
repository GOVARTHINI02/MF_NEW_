...
class FundNetAssets extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $response   =   Http::get('https://api.morningstar.com/v2/service/mf/fuc1yk0i4y0gtaa5/universeid/i9t7jgix6xje3x87?accesscode=egfnfxsxo1rklo0z0su56i9htuu2j49y&format=json');
